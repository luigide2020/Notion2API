...
func builtinModelDefinitions() []ModelDefinition {
	return []ModelDefinition{
		...
		{ID: "gemini-2.5-flash", Name: "Gemini 2.5 Flash", NotionModel: "vertex-gemini-2.5-flash", Family: "gemini", Group: "fast", Enabled: true, Aliases: []string{"gemini25flash", "vertex-gemini-2.5-flash"}},
		...
		{ID: "sonnet-4.6", Name: "Sonnet 4.6", NotionModel: "almond-croissant-low", Family: "anthropic", Group: "fast", Beta: true, Enabled: true, Aliases: []string{"claude-sonnet-4.6", "claude-sonnet4.6", "almond-croissant-low"}},
		{ID: "opus-4.8", Name: "Opus 4.8", NotionModel: "ambrosia-tart-high", Family: "anthropic", Group: "intelligent", Beta: true, Enabled: true, Aliases: []string{"claude-opus-4.8", "claude-opus4.8", "opus48", "ambrosia-tart-high"}},
		{ID: "opus-4.7", Name: "Opus 4.7", NotionModel: "apricot-sorbet-high", Family: "anthropic", Group: "intelligent", Beta: true, Enabled: true, Aliases: []string{"claude-opus-4.7", "claude-opus4.7", "opus47", "apricot-sorbet-high"}},
		{ID: "opus-4.6", Name: "Opus 4.6", NotionModel: "avocado-froyo-medium", Family: "anthropic", Group: "intelligent", Beta: true, Enabled: true, Aliases: []string{"claude-opus-4.6", "claude-opus4.6", "opus46", "avocado-froyo-medium"}},
		...
		{ID: "kimi-2.6", Name: "Kimi 2.6", NotionModel: "fireworks-kimi-k2.6", Family: "mystery", Group: "fast", Enabled: true, Aliases: []string{"kimi26", "fireworks-kimi-k2.6"}},
		{ID: "grok-4.3", Name: "Grok 4.3", NotionModel: "xigua-mochi-medium", Family: "xai", Group: "fast", Beta: true, Enabled: true, Aliases: []string{"grok43", "xigua-mochi-medium"}},
		{ID: "grok-build0.1", Name: "Grok Build 0.1", NotionModel: "xinomavro-cake", Family: "xai", Group: "intelligent", Beta: true, Enabled: true, Aliases: []string{"grokbuild01", "xinomavro-cake"}},
		{ID: "deepseek-v4-pro", Name: "DeepSeek V4 Pro", NotionModel: "baseten-deepseek-v4-pro", Family: "deepseek", Group: "intelligent", Beta: true, Enabled: true, Aliases: []string{"deepseekv4pro", "baseten-deepseek-v4-pro"}},
	}
}
